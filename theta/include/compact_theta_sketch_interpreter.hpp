...
#ifndef COMPACT_THETA_SKETCH_INTERPRETER_HPP_
#define COMPACT_THETA_SKETCH_INTERPRETER_HPP_
...
template<bool dummy>
class compact_theta_sketch_interpreter {
public:
  ...
  static compact_theta_sketch_data interpret(const char* ptr, size_t size, uint64_t seed);
...
#include "compact_theta_sketch_interpreter_impl.hpp"
